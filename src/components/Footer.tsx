...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-6 bg-gray-100 dark:bg-gray-900 text-center mt-auto shadow flex flex-col items-center gap-2">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center text-gray-700 dark:text-gray-200 text-sm">
        ...
        <span className="flex items-center gap-1">
          ...
          {settings?.address || settings?.full_address || "İstanbul, Türkiye"}
        </span>
        <span className="flex items-center gap-1">
